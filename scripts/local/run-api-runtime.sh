...
exec node   --watch   --watch-path=packages/services/api/dist   --watch-path=packages/services/shared/dist   --watch-path=packages/shared/dist   --watch-path=packages/engine/dist   packages/services/api/dist/server.js
