...
exec node   --watch   --watch-path=packages/services/dispatcher/dist   --watch-path=packages/services/shared/dist   --watch-path=packages/shared/dist   --watch-path=packages/engine/dist   packages/services/dispatcher/dist/worker.js
