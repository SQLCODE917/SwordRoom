    ...
    this.httpApi = new apigwv2.CfnApi(this, "HttpApi", {
      ...
      corsConfiguration: {
        ...
        allowHeaders: [
          ...
          "content-type",
          "x-amzn-trace-id",
          "x-swordworld-client-session-id",
          "x-swordworld-client-request-id",
          "x-swordworld-pregame-surface",
          "x-swordworld-pregame-session-id",
          "x-swordworld-pregame-session-started-at",
          "x-swordworld-pregame-session-start",
          "x-swordworld-pregame-entry-source",
          "x-swordworld-pregame-entry-focus",
          "x-swordworld-pregame-wizard-mode",
          "x-swordworld-pregame-draft-mode",
          "x-swordworld-pregame-game-id",
          "x-swordworld-pregame-character-id",
        ],
