...
- `SubmitCharacterForApproval`: `WEB_CHARACTER_WIZARD_STEP_SUBMIT_START`, `WEB_CHARACTER_WIZARD_STEP_SUBMIT_ACCEPTED`, `API_POST_COMMAND_REQUEST`, `API_COMMANDLOG_ACCEPTED`, `API_ENQUEUED`, `DISPATCH_BEGIN`, `DISPATCH_HANDLER_EFFECTS`, `DISPATCH_APPLY_EFFECTS_OK`, `DISPATCHER_MESSAGE_DELETED`, `WEB_CHARACTER_WIZARD_STEP_SUBMIT_OK`.
